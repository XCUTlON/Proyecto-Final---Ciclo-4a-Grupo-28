...
app.config["JWT_SECRET_KEY"] = 'super-secret' # Puede colocar la contraseña que quieras
jwt = JWTManager(app)
...
# Muestra los resultados de una mesa en particular
...
# Muestra los votos de un candidato en todas las mesas
